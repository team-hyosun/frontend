        ...
        {cells.map(cell => {
          ...
          return (
            <button
              ...
              className="relative h-24 border-t border-r border-white/10 text-left p-2 hover:bg-white/5"
            >
              ...
              <div className="mt-5 space-y-1 text-[11px] leading-4">
                <div className="flex items-center gap-2 whitespace-nowrap break-keep">
                  ...
                  <span className={gait ? 'text-red-400' : 'text-white/50'}>
                    {gait ? 'O' : 'X'}
                  </span>
                </div>
                <div className="flex items-center gap-2 whitespace-nowrap break-keep">
                  <span className="text-white/85">약</span>
                  <span className={med ? 'text-red-400' : 'text-white/50'}>
                    {med ? 'O' : 'X'}
                  </span>
                </div>
              </div>
